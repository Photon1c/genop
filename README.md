...
Open `dashboard.html` in a web browser for real-time visualization:

```bash
# Simply open the file in your browser
open genop/dashboard.html
# or
python -m http.server 8000  # Then navigate to http://localhost:8000/genop/dashboard.html
```
...
- **Controls**: Reset and pause/resume simulation
...
- **`dashboard.html`**: Interactive web-based visualization (Three.js)
